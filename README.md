...
[![SkillIcons](https://skillicons.dev/icons?i=python,js,ts,html,css,git,bootstrap,nodejs,react,vite,tailwindcss,mongodb,mysql,aws,vscode,idle,jupternotebook)](https://skillicons.dev)<br/>
<br>
<!-- Remove this line -->
